    ...
    return (
        <section className="w-full flex flex-col lg:flex-row lg:gap-16 xl:gap-28 gap-10 lg:mt-36 mt-16 items-center">
            <div className="order-2 lg:order-1 flex flex-col items-center lg:items-start w-full gap-6">
                <Image
                    src={"/image_3.jpg"}
                    className="object-cover lg:object-none lg:object-left rounded-[24px] lg:h-[460px]"
                    width={630}
                    height={550}
                    alt="Blue sofa"
                />
                <Link href="/store" className=" bg-[#FFD873] rounded-3xl lg:py-3.5 lg:px-6 lg:text-sm py-3 px-4 text-xs lg:self-start inline-block lg:hidden">
                    Open Store
                </Link>
            </div>
            ...
            <div className="flex flex-col w-full lg:gap-12 gap-4 order-1 items-center lg-items-start">
                ...
                <Link href="/store" className="bg-[#FFD873] rounded-3xl lg:py-3.5 lg:px-6 lg:text-sm py-3 px-4 text-xs lg:self-start hidden lg:inline-block">
                    Open Store
                </Link>
            </div>
        </section>
