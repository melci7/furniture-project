...
export default function BottomOfferSection() {
    return (
        <section className="w-full lg:mt-24 mt-16 lg:mb-20 mb-16">
            <div className="bg-[#ffd873] rounded-[24px] flex flex-col lg:flex-row items-center lg:py-8 lg:px-10 xl:px-16 lg:pb-0 lg:pr-4 py-8 px-6 justify-between">
                <div className="flex flex-col lg:items-start items-center lg:gap-7 gap-2 lg:pb-6">
                    <h2 className="xl:text-5xl text-4xl font-semibold font-sans">Winter offer</h2>
                    <p className="xl:text-5xl text-4xl font-medium font-sans">05d : 32h : 35m</p>
